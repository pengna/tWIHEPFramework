...
vartodraw=["M_Mass_bstar","M_DeltaRLeptonClostJet","M_relpt_Jet"]
...
#systs = ["bTag_bc","bTag_udsg","PU","LSF","Trig","PDFHess","WSF","Toppt_a","Toppt_b","Toptag","topsfsemimerged","topsfunmerged","topsfmerged"]
systs = ["bTag_bc","bTag_udsg","PU","LSF","Trig","PDFHess","WSF","Toppt_a","Toppt_b","topsfsemimerged","topsfunmerged","topsfmerged"]
Jetsysts=["JES","JER"]
...
if __name__ == "__main__":
    #Do something to get your nominal and systUp/Down plots here
     ...
     if includeDatadrivenTTInStack : outDir = "plots/2Dcut/"+region+"_scaled/"
     else :  outDir = "plots/2Dcut/"+region+"/"   
