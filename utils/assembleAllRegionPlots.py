...
for i in regions:
    ...
    threads.append(subprocess.Popen("python "+baseDir+"utils/createPlots.py tW"+i+"/ tW"+i+"MCOnly/ tW"+i+"Data/",shell=True))
    threads.append(subprocess.Popen("python "+baseDir+"utils/createPlots.py tWInv"+i+"/ tW"+i+"InvIsoRegion/ tWInv"+i+"Data/",shell=True))
    threads.append(subprocess.Popen("python "+baseDir+"utils/createPlots.py tW"+i+"/ tW"+i+"DDAsQCD/ tW"+i+"Data/ tWInv"+i+"Data/",shell=True))
