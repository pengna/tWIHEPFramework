...
void CutTriggerSelection::BookHistogram(){
  ...
  if (_whichtrigger == 2) _triggerChannel = "bstarMuon";
  if (_whichtrigger == 3) _triggerChannel = "bstarElectron";
...
Bool_t CutTriggerSelection::Apply()
{
  ...
  TEnv *config = GetEventContainer()->GetConfig();
  ...
  if(_DataEra==2016){
	   ...
	   bstarelectronTrigger = EventContainerObj->HLT_Ele27_WPTight_Gsf || EventContainerObj->HLT_Photon175 ||EventContainerObj->HLT_Ele115_CaloIdVT_GsfTrkIdT;
	  if (_whichtrigger == 2) {triggerBit = EventContainerObj->HLT_Mu50 || EventContainerObj->HLT_TkMu50;}
	  if (_whichtrigger == 3) {triggerBit = EventContainerObj->HLT_Ele27_WPTight_Gsf || EventContainerObj->HLT_Photon175 ||EventContainerObj->HLT_Ele115_CaloIdVT_GsfTrkIdT;}
  }
	  ...
	  if (_whichtrigger == 3) {triggerBit = EventContainerObj->HLT_Ele35_WPTight_Gsf || EventContainerObj->HLT_Photon200 ||EventContainerObj->HLT_Ele115_CaloIdVT_GsfTrkIdT;}
 	   ...
 	   bstarmuonTrigger = EventContainerObj->HLT_Mu50 ||EventContainerObj->HLT_OldMu100 || EventContainerObj->HLT_TkMu100;
           bstarelectronTrigger =EventContainerObj->HLT_Ele32_WPTight_Gsf || EventContainerObj->HLT_Photon200 ||EventContainerObj->HLT_Ele115_CaloIdVT_GsfTrkIdT; 
	  if (_whichtrigger == 2) {triggerBit = EventContainerObj->HLT_Mu50 ||EventContainerObj->HLT_OldMu100 || EventContainerObj->HLT_TkMu100;}
	  if (_whichtrigger == 3) {triggerBit = EventContainerObj->HLT_Ele32_WPTight_Gsf || EventContainerObj->HLT_Photon200 ||EventContainerObj->HLT_Ele115_CaloIdVT_GsfTrkIdT;}
  }
 ...
 // if (_whichtrigger == 3) passesTrigger = bstarelectronTrigger != 0.;
