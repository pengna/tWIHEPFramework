...
Bool_t CutTriggerSelection::Apply()
{
  ...
  Int_t muonTrigger = EventContainerObj->HLT_IsoMu22 || EventContainerObj->HLT_IsoTkMu22;
  ...
  if (_whichtrigger == 1) {//I should really make these customisable, but I'm not gonna do that now.
    ...
    triggerBit = EventContainerObj->HLT_IsoMu22 || EventContainerObj->HLT_IsoTkMu22;
  }
