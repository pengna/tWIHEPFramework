 ...
 *    HistogrammingUnTaggedJet()        -- Parameterized Constructor          *
 *    ~HistogrammingUnTaggedJet()       -- Destructor                         *
 *    BookHistogram()                   -- Book histograms                    *
 *    Apply()                           -- Fill histograms only (No Cuts)     *
 *    GetCutName()                      -- Returns "HistogrammingUnTaggedJet" *
 *                                                                            *
...
#ifndef HistogrammingUnTaggedJet_h
#define HistogrammingUnTaggedJet_h

#include "SingleTopRootAnalysis/Base/Dictionary/HistoCut.hpp"
#include "SingleTopRootAnalysis/Base/Dictionary/EventContainer.hpp"


class HistogrammingUnTaggedJet : public HistoCut 
{

public:

  // Parameterized Constructor
  HistogrammingUnTaggedJet(EventContainer *obj);
  
  // Destructor
  ~HistogrammingUnTaggedJet();

  // Get the name describing the cut
  inline std::string GetCutName() { return "HistogrammingUnTaggedJet"; };
