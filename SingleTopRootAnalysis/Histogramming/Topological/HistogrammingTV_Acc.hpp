 ...
 *    HistogrammingTV_Acc()              -- Parameterized Constructor       *
 *    ~HistogrammingTV_Acc()             -- Destructor                      *
 *    BookHistogram()                   -- Book histograms                    *
 *    Apply()                           -- Fill histograms only (No Cuts)     *
 *    GetCutName()                      -- Returns "HistogrammingTV_Acc"    *
 *                                                                            *
...
#ifndef HistogrammingTV_Acc_h
#define HistogrammingTV_Acc_h
...
class HistogrammingTV_Acc : public HistoCut 
{

public:

  HistogrammingTV_Acc(EventContainer *obj,TFile *skimFilez);
  ...
  inline std::string GetCutName (void) { return "HistogrammingTV_Acc"; };
