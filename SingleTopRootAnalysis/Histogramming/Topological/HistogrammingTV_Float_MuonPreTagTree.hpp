/******************************************************************************
 * HistogrammingTV_Float_MuonPreTagTree.hpp                                                  *
 *                                                                            *
 ...
 *    HistogrammingTV_Float_MuonPreTagTree()              -- Parameterized Constructor       *
 *    ~HistogrammingTV_Float_MuonPreTagTree()             -- Destructor                      *
 *    BookHistogram()                   -- Book histograms                    *
 *    Apply()                           -- Fill histograms only (No Cuts)     *
 *    GetCutName()                      -- Returns "HistogrammingTV_Float_MuonPreTagTree"    *
 *                                                                            *
...
#ifndef HistogrammingTV_Float_MuonPreTagTree_h
#define HistogrammingTV_Float_MuonPreTagTree_h
...
class HistogrammingTV_Float_MuonPreTagTree : public HistoCut 
{

public:

  HistogrammingTV_Float_MuonPreTagTree(EventContainer *obj,TFile *skimFilez);
  
  // destructor
  ~HistogrammingTV_Float_MuonPreTagTree();

  // methods:
  void BookHistogram();
  bool Apply();
  
  inline std::string GetCutName (void) { return "HistogrammingTV_Float_MuonPreTagTree"; };
