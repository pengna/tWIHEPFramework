/******************************************************************************
 * HistogrammingTV_Float_ElectronLooseTree.hpp                                                  *
 *                                                                            *
 ...
 *    HistogrammingTV_Float_ElectronLooseTree()              -- Parameterized Constructor       *
 *    ~HistogrammingTV_Float_ElectronLooseTree()             -- Destructor                      *
 *    BookHistogram()                   -- Book histograms                    *
 *    Apply()                           -- Fill histograms only (No Cuts)     *
 *    GetCutName()                      -- Returns "HistogrammingTV_Float_ElectronLooseTree"    *
 *                                                                            *
...
#ifndef HistogrammingTV_Float_ElectronLooseTree_h
#define HistogrammingTV_Float_ElectronLooseTree_h
...
class HistogrammingTV_Float_ElectronLooseTree : public HistoCut 
{

public:

  HistogrammingTV_Float_ElectronLooseTree(EventContainer *obj,TFile *skimFilez);
  
  // destructor
  ~HistogrammingTV_Float_ElectronLooseTree();

  // methods:
  void BookHistogram();
  bool Apply();
  
  inline std::string GetCutName (void) { return "HistogrammingTV_Float_ElectronLooseTree"; };
