/******************************************************************************
 * HistogrammingTV_Float_ElectronPreTagTree.hpp                                                  *
 *                                                                            *
 ...
 *    HistogrammingTV_Float_ElectronPreTagTree()              -- Parameterized Constructor       *
 *    ~HistogrammingTV_Float_ElectronPreTagTree()             -- Destructor                      *
 *    BookHistogram()                   -- Book histograms                    *
 *    Apply()                           -- Fill histograms only (No Cuts)     *
 *    GetCutName()                      -- Returns "HistogrammingTV_Float_ElectronPreTagTree"    *
 *                                                                            *
...
#ifndef HistogrammingTV_Float_ElectronPreTagTree_h
#define HistogrammingTV_Float_ElectronPreTagTree_h
...
class HistogrammingTV_Float_ElectronPreTagTree : public HistoCut 
{

public:

  HistogrammingTV_Float_ElectronPreTagTree(EventContainer *obj,TFile *skimFilez);
  
  // destructor
  ~HistogrammingTV_Float_ElectronPreTagTree();

  // methods:
  void BookHistogram();
  bool Apply();
  
  inline std::string GetCutName (void) { return "HistogrammingTV_Float_ElectronPreTagTree"; };
