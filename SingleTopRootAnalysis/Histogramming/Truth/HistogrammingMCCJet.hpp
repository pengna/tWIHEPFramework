 ...
 *    HistogrammingMCCJet()              -- Parameterized Constructor        *
 *    ~HistogrammingMCCJet()             -- Destructor                       *
 ...
 *                                                                           *
 * History                                                                   *
 *     17 Jul 2007- Created by J. Holzbauer, based on HistogrammingMCBJet    *
 *****************************************************************************/

#ifndef HistogrammingMCCJet_h
#define HistogrammingMCCJet_h

#include "SingleTopRootAnalysis/Base/Dictionary/HistoCut.hpp"
#include "SingleTopRootAnalysis/Base/Dictionary/EventContainer.hpp"


class HistogrammingMCCJet : public HistoCut 
{

public:

  // Parameterized Constructor
  HistogrammingMCCJet(EventContainer *obj);
  
  // Destructor
  ~HistogrammingMCCJet();

  // Get the name describing the cut
  inline std::string GetCutName() { return "HistogrammingMCCJet"; };
