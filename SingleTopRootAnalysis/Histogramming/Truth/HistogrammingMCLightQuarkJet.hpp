/*****************************************************************************
 * HistogrammingMCLightQuarkJet.hpp                                          *
 *                                                                           *
 ...
 *    HistogrammingMCLightQuarkJet()     -- Parameterized Constructor        *
 *    ~HistogrammingMCLightQuarkJet()    -- Destructor                       *
 ...
 *                                                                           *
 * History                                                                   *
 *     17 Jul 2007- Created by J. Holzbauer, based on HistogrammingMBJet     *
 *****************************************************************************/

#ifndef HistogrammingMCLightQuarkJet_h
#define HistogrammingMCLightQuarkJet_h

#include "SingleTopRootAnalysis/Base/Dictionary/HistoCut.hpp"
#include "SingleTopRootAnalysis/Base/Dictionary/EventContainer.hpp"


class HistogrammingMCLightQuarkJet : public HistoCut 
{

public:

  // Parameterized Constructor
  HistogrammingMCLightQuarkJet(EventContainer *obj);
  
  // Destructor
  ~HistogrammingMCLightQuarkJet();

  // Get the name describing the cut
  inline std::string GetCutName() { return "HistogrammingMCLightQuarkJet"; };
