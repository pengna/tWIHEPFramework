 ...
 *    HistogrammingMCJet()              -- Parameterized Constructor         *
 *    ~HistogrammingMCJet()             -- Destructor                        *
...
#ifndef HistogrammingMCJet_h
#define HistogrammingMCJet_h

#include "SingleTopRootAnalysis/Base/Dictionary/HistoCut.hpp"
#include "SingleTopRootAnalysis/Base/Dictionary/EventContainer.hpp"


class HistogrammingMCJet : public HistoCut 
{

public:

  // Parameterized Constructor
  HistogrammingMCJet(EventContainer *obj);
  
  // Destructor
  ~HistogrammingMCJet();

  // Get the name describing the cut
  inline std::string GetCutName() { return "HistogrammingMCJet"; };
