 ...
 *    HistogrammingMCBQuark()              -- Parameterized Constructor        *
 *    ~HistogrammingMCBQuark()             -- Destructor                       *
 ...
 *                                                                           *
 * History                                                                   *
 *     25 Jun 2007- Created by J. Holzbauer, based on HistogrammingMCQuark     *
 *****************************************************************************/

#ifndef HistogrammingMCBQuark_h
#define HistogrammingMCBQuark_h

#include "SingleTopRootAnalysis/Base/Dictionary/HistoCut.hpp"
#include "SingleTopRootAnalysis/Base/Dictionary/EventContainer.hpp"


class HistogrammingMCBQuark : public HistoCut 
{

public:

  // Parameterized Constructor
  HistogrammingMCBQuark(EventContainer *obj);
  
  // Destructor
  ~HistogrammingMCBQuark();

  // Get the name describing the cut
  inline std::string GetCutName() { return "HistogrammingMCBQuark"; };
