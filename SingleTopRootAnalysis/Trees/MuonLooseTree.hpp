...
// Thu Jun 23 15:27:38 2011 by ROOT version 5.28/00a
// from TTree MuonLooseTree/MuonLooseTree
...
#ifndef MuonLooseTree_h
#define MuonLooseTree_h
...
public :
   ...
   Float_t         Lepton_id_pt;
   Float_t         Lepton_id_eta;
   Float_t         Lepton_me_pt;
   Float_t         Lepton_me_eta;
   ...
   TBranch        *b_Lepton_isGoodIDTrack;   //!
   TBranch        *b_Lepton_pt;   //!
   ...
   TBranch        *b_Lepton_id_pt;   //!
   TBranch        *b_Lepton_id_eta;   //!
   TBranch        *b_Lepton_me_pt;   //!
   TBranch        *b_Lepton_me_eta;   //!
   ...
   MuonLooseTree(TTree *tree=0);
   virtual ~MuonLooseTree();
...
#ifdef MuonLooseTree_cxx
MuonLooseTree::MuonLooseTree(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("MuonLooseTree");

   }
   Init(tree);
}

MuonLooseTree::~MuonLooseTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MuonLooseTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MuonLooseTree::LoadTree(Long64_t entry)
{
...
void MuonLooseTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Lepton_isGoodIDTrack", &Lepton_isGoodIDTrack, &b_Lepton_isGoodIDTrack);
   ...
   fChain->SetBranchAddress("Lepton_Et", &Lepton_Et, &b_Lepton_Et);
   ...
   fChain->SetBranchAddress("Lepton_id_pt", &Lepton_id_pt, &b_Lepton_id_pt);
   fChain->SetBranchAddress("Lepton_id_eta", &Lepton_id_eta, &b_Lepton_id_eta);
   fChain->SetBranchAddress("Lepton_me_pt", &Lepton_me_pt, &b_Lepton_me_pt);
   fChain->SetBranchAddress("Lepton_me_eta", &Lepton_me_eta, &b_Lepton_me_eta);
   ...
   fChain->SetBranchAddress("Lepton_useTight", &Lepton_useTight, &b_Lepton_useTight);
...
void MuonLooseTree::Show(Long64_t entry)
{
...
Int_t MuonLooseTree::Cut(Long64_t entry)
{
