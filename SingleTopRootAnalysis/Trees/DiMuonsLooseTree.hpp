...
// Thu Jun 23 15:27:32 2011 by ROOT version 5.28/00a
// from TTree DiMuonsLooseTree/DiMuonsLooseTree
...
#ifndef DiMuonsLooseTree_h
#define DiMuonsLooseTree_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class DiMuonsLooseTree {
public :
   ...
   Float_t         Lepton1_id_pt;
   Float_t         Lepton1_id_eta;
   Float_t         Lepton1_me_pt;
   Float_t         Lepton1_me_eta;
   ...
   TBranch        *b_Lepton1_id_pt;   //!
   TBranch        *b_Lepton1_id_eta;   //!
   TBranch        *b_Lepton1_me_pt;   //!
   TBranch        *b_Lepton1_me_eta;   //!
   ...
   DiMuonsLooseTree(TTree *tree=0);
   virtual ~DiMuonsLooseTree();
...
#ifdef DiMuonsLooseTree_cxx
DiMuonsLooseTree::DiMuonsLooseTree(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("DiMuonsLooseTree");

   }
   Init(tree);
}

DiMuonsLooseTree::~DiMuonsLooseTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DiMuonsLooseTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DiMuonsLooseTree::LoadTree(Long64_t entry)
{
...
void DiMuonsLooseTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Lepton1_isGoodIDTrack", &Lepton1_isGoodIDTrack, &b_Lepton1_isGoodIDTrack);
   ...
   fChain->SetBranchAddress("Lepton1_E", &Lepton1_E, &b_Lepton1_E);
   fChain->SetBranchAddress("Lepton1_Et", &Lepton1_Et, &b_Lepton1_Et);
   ...
   fChain->SetBranchAddress("Lepton1_id_pt", &Lepton1_id_pt, &b_Lepton1_id_pt);
   fChain->SetBranchAddress("Lepton1_id_eta", &Lepton1_id_eta, &b_Lepton1_id_eta);
   fChain->SetBranchAddress("Lepton1_me_pt", &Lepton1_me_pt, &b_Lepton1_me_pt);
   fChain->SetBranchAddress("Lepton1_me_eta", &Lepton1_me_eta, &b_Lepton1_me_eta);
...
Bool_t DiMuonsLooseTree::Notify()
{
...
void DiMuonsLooseTree::Show(Long64_t entry)
{
...
Int_t DiMuonsLooseTree::Cut(Long64_t entry)
{
...
#endif // #ifdef DiMuonsLooseTree_cxx
