...
// Thu Jun 23 15:27:30 2011 by ROOT version 5.28/00a
// from TTree DiElectronsLooseTree/DiElectronsLooseTree
...
#ifndef DiElectronsLooseTree_h
#define DiElectronsLooseTree_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class DiElectronsLooseTree {
public :
   ...
   UInt_t          Lepton2_loose;
   UInt_t          Lepton2_medium;
   UInt_t          Lepton2_mediumIso;
   UInt_t          Lepton2_tight;
   UInt_t          Lepton2_tightIso;
   UInt_t          Lepton2_trackBlayer;
   UInt_t          Lepton2_trackMatchEoverP;
   UInt_t          Lepton2_trackTRThits;
   UInt_t          Lepton2_trackTRTratio;
   UInt_t          Lepton2_trackA0Tight;
   UInt_t          Lepton2_trackMatchEtaTight;
   UInt_t          Lepton2_trackMatchPhi;
   UInt_t          Lepton2_conversionMatch;
   Int_t           Lepton2_Barcode;
   Int_t           Lepton2_pdgId;
   Float_t         Lepton2_charge;
   Float_t         Lepton2_Etcone45;
   ...
   Float_t         Lepton2_cluster_pt;
   Float_t         Lepton2_cluster_eta;
   Float_t         Lepton2_cluster_phi;
   Float_t         Lepton2_cluster_E;
   Float_t         Lepton2_cluster_Et;
   Float_t         Lepton2_cluster_track_Et;
   Float_t         Lepton2_track_d0;
   Float_t         Lepton2_track_z0;
   Float_t         Lepton2_track_phi;
   Float_t         Lepton2_track_theta;
   Float_t         Lepton2_track_qoverp;
   Float_t         Lepton2_track_pt;
   Float_t         Lepton2_track_eta;
   ...
   Bool_t          Lepton1_useTight;
   Bool_t          Lepton2_useTight;
   Int_t           VetoJet_n;
   ...
   TBranch        *b_Lepton2_loose;   //!
   TBranch        *b_Lepton2_medium;   //!
   TBranch        *b_Lepton2_mediumIso;   //!
   TBranch        *b_Lepton2_tight;   //!
   TBranch        *b_Lepton2_tightIso;   //!
   TBranch        *b_Lepton2_trackBlayer;   //!
   TBranch        *b_Lepton2_trackMatchEoverP;   //!
   TBranch        *b_Lepton2_trackTRThits;   //!
   TBranch        *b_Lepton2_trackTRTratio;   //!
   TBranch        *b_Lepton2_trackA0Tight;   //!
   TBranch        *b_Lepton2_trackMatchEtaTight;   //!
   TBranch        *b_Lepton2_trackMatchPhi;   //!
   TBranch        *b_Lepton2_conversionMatch;   //!
   TBranch        *b_Lepton2_Barcode;   //!
   TBranch        *b_Lepton2_pdgId;   //!
   TBranch        *b_Lepton2_charge;   //!
   TBranch        *b_Lepton2_Etcone45;   //!
   ...
   TBranch        *b_Lepton2_cluster_pt;   //!
   TBranch        *b_Lepton2_cluster_eta;   //!
   TBranch        *b_Lepton2_cluster_phi;   //!
   TBranch        *b_Lepton2_cluster_E;   //!
   TBranch        *b_Lepton2_cluster_Et;   //!
   TBranch        *b_Lepton2_cluster_track_Et;   //!
   TBranch        *b_Lepton2_track_d0;   //!
   TBranch        *b_Lepton2_track_z0;   //!
   TBranch        *b_Lepton2_track_phi;   //!
   TBranch        *b_Lepton2_track_theta;   //!
   TBranch        *b_Lepton2_track_qoverp;   //!
   TBranch        *b_Lepton2_track_pt;   //!
   TBranch        *b_Lepton2_track_eta;   //!
   ...
   TBranch        *b_Lepton1_useTight;   //!
   TBranch        *b_Lepton2_useTight;   //!
   TBranch        *b_VetoJet_n;   //!
   ...
   DiElectronsLooseTree(TTree *tree=0);
   virtual ~DiElectronsLooseTree();
...
#ifdef DiElectronsLooseTree_cxx
DiElectronsLooseTree::DiElectronsLooseTree(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("DiElectronsLooseTree");

   }
   Init(tree);
}

DiElectronsLooseTree::~DiElectronsLooseTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DiElectronsLooseTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DiElectronsLooseTree::LoadTree(Long64_t entry)
{
...
void DiElectronsLooseTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Lepton2_loose", &Lepton2_loose, &b_Lepton2_loose);
   fChain->SetBranchAddress("Lepton2_medium", &Lepton2_medium, &b_Lepton2_medium);
   fChain->SetBranchAddress("Lepton2_mediumIso", &Lepton2_mediumIso, &b_Lepton2_mediumIso);
   fChain->SetBranchAddress("Lepton2_tight", &Lepton2_tight, &b_Lepton2_tight);
   fChain->SetBranchAddress("Lepton2_tightIso", &Lepton2_tightIso, &b_Lepton2_tightIso);
   fChain->SetBranchAddress("Lepton2_trackBlayer", &Lepton2_trackBlayer, &b_Lepton2_trackBlayer);
   fChain->SetBranchAddress("Lepton2_trackMatchEoverP", &Lepton2_trackMatchEoverP, &b_Lepton2_trackMatchEoverP);
   fChain->SetBranchAddress("Lepton2_trackTRThits", &Lepton2_trackTRThits, &b_Lepton2_trackTRThits);
   fChain->SetBranchAddress("Lepton2_trackTRTratio", &Lepton2_trackTRTratio, &b_Lepton2_trackTRTratio);
   fChain->SetBranchAddress("Lepton2_trackA0Tight", &Lepton2_trackA0Tight, &b_Lepton2_trackA0Tight);
   fChain->SetBranchAddress("Lepton2_trackMatchEtaTight", &Lepton2_trackMatchEtaTight, &b_Lepton2_trackMatchEtaTight);
   fChain->SetBranchAddress("Lepton2_trackMatchPhi", &Lepton2_trackMatchPhi, &b_Lepton2_trackMatchPhi);
   fChain->SetBranchAddress("Lepton2_conversionMatch", &Lepton2_conversionMatch, &b_Lepton2_conversionMatch);
   ...
   fChain->SetBranchAddress("Lepton2_Etcone45", &Lepton2_Etcone45, &b_Lepton2_Etcone45);
   ...
   fChain->SetBranchAddress("Lepton2_cluster_pt", &Lepton2_cluster_pt, &b_Lepton2_cluster_pt);
   fChain->SetBranchAddress("Lepton2_cluster_eta", &Lepton2_cluster_eta, &b_Lepton2_cluster_eta);
   fChain->SetBranchAddress("Lepton2_cluster_phi", &Lepton2_cluster_phi, &b_Lepton2_cluster_phi);
   fChain->SetBranchAddress("Lepton2_cluster_E", &Lepton2_cluster_E, &b_Lepton2_cluster_E);
   fChain->SetBranchAddress("Lepton2_cluster_Et", &Lepton2_cluster_Et, &b_Lepton2_cluster_Et);
   fChain->SetBranchAddress("Lepton2_cluster_track_Et", &Lepton2_cluster_track_Et, &b_Lepton2_cluster_track_Et);
   fChain->SetBranchAddress("Lepton2_track_d0", &Lepton2_track_d0, &b_Lepton2_track_d0);
   fChain->SetBranchAddress("Lepton2_track_z0", &Lepton2_track_z0, &b_Lepton2_track_z0);
   fChain->SetBranchAddress("Lepton2_track_phi", &Lepton2_track_phi, &b_Lepton2_track_phi);
   fChain->SetBranchAddress("Lepton2_track_theta", &Lepton2_track_theta, &b_Lepton2_track_theta);
   fChain->SetBranchAddress("Lepton2_track_qoverp", &Lepton2_track_qoverp, &b_Lepton2_track_qoverp);
   fChain->SetBranchAddress("Lepton2_track_pt", &Lepton2_track_pt, &b_Lepton2_track_pt);
   fChain->SetBranchAddress("Lepton2_track_eta", &Lepton2_track_eta, &b_Lepton2_track_eta);
   ...
   fChain->SetBranchAddress("Lepton1_useTight", &Lepton1_useTight, &b_Lepton1_useTight);
   fChain->SetBranchAddress("Lepton2_useTight", &Lepton2_useTight, &b_Lepton2_useTight);
...
Bool_t DiElectronsLooseTree::Notify()
{
...
void DiElectronsLooseTree::Show(Long64_t entry)
{
...
Int_t DiElectronsLooseTree::Cut(Long64_t entry)
{
...
#endif // #ifdef DiElectronsLooseTree_cxx
