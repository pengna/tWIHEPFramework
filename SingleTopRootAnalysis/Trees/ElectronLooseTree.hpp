...
// Thu Jun 23 15:27:34 2011 by ROOT version 5.28/00a
// from TTree ElectronLooseTree/ElectronLooseTree
...
#ifndef ElectronLooseTree_h
#define ElectronLooseTree_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class ElectronLooseTree {
public :
   ...
   ElectronLooseTree(TTree *tree=0);
   virtual ~ElectronLooseTree();
...
#ifdef ElectronLooseTree_cxx
ElectronLooseTree::ElectronLooseTree(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("ElectronLooseTree");

   }
   Init(tree);
}

ElectronLooseTree::~ElectronLooseTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ElectronLooseTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ElectronLooseTree::LoadTree(Long64_t entry)
{
...
void ElectronLooseTree::Init(TTree *tree)
{
...
Bool_t ElectronLooseTree::Notify()
{
...
void ElectronLooseTree::Show(Long64_t entry)
{
...
Int_t ElectronLooseTree::Cut(Long64_t entry)
{
...
#endif // #ifdef ElectronLooseTree_cxx
