...
// Thu Jun 23 15:27:33 2011 by ROOT version 5.28/00a
// from TTree DiMuonsPreTagTree/DiMuonsPreTagTree
...
#ifndef DiMuonsPreTagTree_h
#define DiMuonsPreTagTree_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class DiMuonsPreTagTree {
public :
   ...
   DiMuonsPreTagTree(TTree *tree=0);
   virtual ~DiMuonsPreTagTree();
...
#ifdef DiMuonsPreTagTree_cxx
DiMuonsPreTagTree::DiMuonsPreTagTree(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("DiMuonsPreTagTree");

   }
   Init(tree);
}

DiMuonsPreTagTree::~DiMuonsPreTagTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DiMuonsPreTagTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DiMuonsPreTagTree::LoadTree(Long64_t entry)
{
...
void DiMuonsPreTagTree::Init(TTree *tree)
{
...
Bool_t DiMuonsPreTagTree::Notify()
{
...
void DiMuonsPreTagTree::Show(Long64_t entry)
{
...
Int_t DiMuonsPreTagTree::Cut(Long64_t entry)
{
...
#endif // #ifdef DiMuonsPreTagTree_cxx
