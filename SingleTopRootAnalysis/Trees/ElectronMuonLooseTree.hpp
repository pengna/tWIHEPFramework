...
// from TTree ElectronMuonLooseTree/ElectronMuonLooseTree
...
#ifndef ElectronMuonLooseTree_h
#define ElectronMuonLooseTree_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class ElectronMuonLooseTree {
public :
   ...
   ElectronMuonLooseTree(TTree *tree=0);
   virtual ~ElectronMuonLooseTree();
...
#ifdef ElectronMuonLooseTree_cxx
ElectronMuonLooseTree::ElectronMuonLooseTree(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("ElectronMuonLooseTree");

   }
   Init(tree);
}

ElectronMuonLooseTree::~ElectronMuonLooseTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ElectronMuonLooseTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ElectronMuonLooseTree::LoadTree(Long64_t entry)
{
...
void ElectronMuonLooseTree::Init(TTree *tree)
{
...
Bool_t ElectronMuonLooseTree::Notify()
{
...
void ElectronMuonLooseTree::Show(Long64_t entry)
{
...
Int_t ElectronMuonLooseTree::Cut(Long64_t entry)
{
...
#endif // #ifdef ElectronMuonLooseTree_cxx
