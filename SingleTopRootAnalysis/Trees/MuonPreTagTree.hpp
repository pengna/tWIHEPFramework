...
// Thu Jun 23 15:27:39 2011 by ROOT version 5.28/00a
// from TTree MuonPreTagTree/MuonPreTagTree
...
#ifndef MuonPreTagTree_h
#define MuonPreTagTree_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class MuonPreTagTree {
public :
   ...
   MuonPreTagTree(TTree *tree=0);
   virtual ~MuonPreTagTree();
...
#ifdef MuonPreTagTree_cxx
MuonPreTagTree::MuonPreTagTree(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("MuonPreTagTree");

   }
   Init(tree);
}

MuonPreTagTree::~MuonPreTagTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MuonPreTagTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MuonPreTagTree::LoadTree(Long64_t entry)
{
...
void MuonPreTagTree::Init(TTree *tree)
{
...
void MuonPreTagTree::Show(Long64_t entry)
{
...
Int_t MuonPreTagTree::Cut(Long64_t entry)
{
...
#endif // #ifdef MuonPreTagTree_cxx
