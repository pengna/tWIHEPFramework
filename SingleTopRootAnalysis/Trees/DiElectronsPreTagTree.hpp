...
// Thu Jun 23 15:27:31 2011 by ROOT version 5.28/00a
// from TTree DiElectronsPreTagTree/DiElectronsPreTagTree
...
#ifndef DiElectronsPreTagTree_h
#define DiElectronsPreTagTree_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class DiElectronsPreTagTree {
public :
   ...
   DiElectronsPreTagTree(TTree *tree=0);
   virtual ~DiElectronsPreTagTree();
...
#ifdef DiElectronsPreTagTree_cxx
DiElectronsPreTagTree::DiElectronsPreTagTree(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("DiElectronsPreTagTree");

   }
   Init(tree);
}

DiElectronsPreTagTree::~DiElectronsPreTagTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DiElectronsPreTagTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DiElectronsPreTagTree::LoadTree(Long64_t entry)
{
...
void DiElectronsPreTagTree::Init(TTree *tree)
{
...
Bool_t DiElectronsPreTagTree::Notify()
{
...
void DiElectronsPreTagTree::Show(Long64_t entry)
{
...
Int_t DiElectronsPreTagTree::Cut(Long64_t entry)
{
...
#endif // #ifdef DiElectronsPreTagTree_cxx
