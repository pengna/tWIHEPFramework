 ...
 * CutTriggerAND.hpp                                                          *
 *                                                                            *
 * Cuts on 1 or more CutTriggerANDs                                           *
 * Selection perforemed with full trigger (L1, L2, EF)                        *
 *                                                                            *
 * Derived from HistoCut which is in turn derived from BaseCut                *
 *                                                                            *
 * Public Member Functions of CutMuonPt1 class                                *
 *    CutTriggerAND()                -- Parameterized Constructor             *
 *    ~CutTriggerAND()               -- Destructor                            *
 *    BookHistogram()                -- Book histograms                       *
 *    Apply()                        -- Apply cuts and fill histograms        *
 *    GetCutName()                   -- Returns "CutTriggerANDOR"             *
 *                                                                            *
 * Private Data Members of CutTriggerANDOR class                              *
...
class CutTriggerAND : public HistoCut 
{

public:

  // Parameterized Constructor
  CutTriggerAND(EventContainer *EventContainerObj, std::string CutTriggerANDNamePassed = "NOTHINGPASSED");
  ...
  ///////////// Change this
  inline std::string GetCutName() { return "CutTriggerAND_" + _TriggerAndName; };
...
private:
  ...
  // Histograms
  myTH1F* _hTriggerAndBefore;    // Histogram Muon Before CutTriggerAND Cut
  myTH1F* _hTriggerAndAfter;          // Histogram Muon After CutTriggerAND Cut

  // Cut parameters
  std::vector<TString> _TriggerAndNameVector;    // Vector of trigger names
  std::string _TriggerAndName;                   // A single trigger name
