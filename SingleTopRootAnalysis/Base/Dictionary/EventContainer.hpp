...
// W_tagging weight up per event 
 ...
 inline Double_t EventTopptreweight() const {return GetEventTopptreweight();};
   ...
   inline void SetEventTopptreweight_a_Up(const Double_t& w_TopPt_a_Up_) {_EventTopptreweight_a_Up = w_TopPt_a_Up_;}; //tagging prob per event
   inline Double_t GetEventTopptreweight_a_Up() const {return _EventTopptreweight_a_Up;};
   inline Double_t EventTopptreweight_a_Up() const {return GetEventTopptreweight_a_Up();};
   
   inline void SetEventTopptreweight_a_Down(const Double_t& w_TopPt_a_Down_) {_EventTopptreweight_a_Down = w_TopPt_a_Down_;}; //tagging prob per event
        inline Double_t GetEventTopptreweight_a_Down() const {return _EventTopptreweight_a_Down;};
        inline Double_t EventTopptreweight_a_Down() const {return GetEventTopptreweight_a_Down();};

   inline void SetEventTopptreweight_b_Up(const Double_t& w_TopPt_b_Up_) {_EventTopptreweight_b_Up = w_TopPt_b_Up_;}; //tagging prob per event
   inline Double_t GetEventTopptreweight_b_Up() const {return _EventTopptreweight_b_Up;};
   inline Double_t EventTopptreweight_b_Up() const {return GetEventTopptreweight_b_Up();};
   
   inline void SetEventTopptreweight_b_Down(const Double_t& w_TopPt_b_Down_) {_EventTopptreweight_b_Down = w_TopPt_b_Down_;}; //tagging prob per event
        inline Double_t GetEventTopptreweight_b_Down() const {return _EventTopptreweight_b_Down;};
        inline Double_t EventTopptreweight_b_Down() const {return GetEventTopptreweight_b_Down();};
 ...
 //Tagging probabiliy weight per event
  ...
  Float_t _EventTopptreweight_a_Up;
  Float_t _EventTopptreweight_b_Up;
  Float_t _EventTopptreweight_a_Down;
  Float_t _EventTopptreweight_b_Down;
  ...
  std::vector<BoostedJet> basedboostedjets;
  std::vector<BoostedJet> allboostedjets;
  std::vector<Jet>        alljets;//no jet checks
  std::vector<Jet>        Beforeak8jetcleanjets;
  std::vector<Jet>        taggedBeforeak8jetcleanjets;
  std::vector<Jet>        untaggedBeforeak8jetcleanjets;
